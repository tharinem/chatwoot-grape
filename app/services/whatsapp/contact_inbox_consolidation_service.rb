...
# (app/services/whatsapp/contact_inbox_consolidation_service.rb). Decision: PORT (RESEARCH
# Open Question 2) — self-contained, no migration, resolves the @lid vs phone duplicate-contact
# bug in the individual-contact handler's set_contact.
#
